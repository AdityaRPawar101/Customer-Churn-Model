...
def churn_prediction(tenure, citytier, warehousetohome, gender, hourspendonapp, numberofdeviceregistered, satisfactionscore, maritalstatus, numberofaddress, complain, orderamounthikefromlastyear, couponused, ordercount, daysincelastorder, cashbackamount):
    with open('D:\Projects\Churn Prediction Model Experiment\end_to_end_deployment\models\churn_prediction_model.pkl', 'rb') as f:
        model = pickle.load(f)

    with open("D:\Projects\Churn Prediction Model Experiment\end_to_end_deployment\models\columns.json", "r") as f:
